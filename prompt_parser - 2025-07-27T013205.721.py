...
prompt_core: scheduled | emphasized | grouped | alternate | alternate_distinct | alternate1 | alternate2 | sequence | nested_sequence | top_level_sequence | compound | numbered | and_rule | plain

reverse_flag: "reverse" | "r"
step_range_list: step_range ("," step_range)*
step_range: NUMBER_Q "-" NUMBER_Q | NUMBER_Q "%-" NUMBER_Q "%"

!emphasized: "(" prompt ")" (":" NUMBER_Q)? | "[" prompt "]"
...
!nested_sequence: "::" plain ("," | ";")
!top_level_sequence: plain "::" sequence ("!!" | "::" sequence)*

!grouped: "{" (prompt_core | NUMBER_Q) ("," | "|")* "}"
!compound: /[a-zA-Z][a-zA-Z0-9]*(_[a-zA-Z0-9]+)+/
...
%ignore WHITESPACE
""", start="start", parser="lalr", propagate_positions=True)
