        ...
        if step_range_list:
            for sr in step_range_list.children:
                ...
                if data not in ("range_abs", "range_pct", "step_range"):
                    continue
                # Извлекаем числа надёжно: сначала токены NUMBER из детей,
                # а если не хватило — парсим целиком текст узла регэкспом.
                ...
                # допускаем одношаговые интервалы, чтобы "6-6" работало
